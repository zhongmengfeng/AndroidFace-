...
//		headers.put(Ckey.phoneType, SPutils.get(Ckey.phoneType));
    ...
    public static void uploadHeadFile(final String url, File file,
        ...
        builder.addParams("api_key", Common.KEY);
        builder.addParams("api_secret",Common.SECRET);
        builder.addParams("faceset_token","0636196484660b5f92b90461261d569a");
        builder.url(url).addFile("image_file", file.getName(), file).build()
                .readTimeOut(20000)
                .writeTimeOut(20000)
                .connTimeOut(20000)
                .execute(new StringCallback() {
